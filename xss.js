...
reInitializeWebPage = function() {
	...
	wp.onAlert = function(msg) {
		...
		xss.value = 1;
		xss.msg += 'flag{You_found_XSS_EZ}: alert(' + msg + ')';
	};
	wp.onConsoleMessage = function(msg) {
		console.log("On console.log: " + msg);
		
		xss.value = 1;
		xss.msg += 'flag{You_found_XSS_EZ}: console.log(' + msg + ')';
	};
	wp.onConfirm = function(msg) {
		console.log("On confirm: " + msg);
		
		xss.value = 1;
		xss.msg += 'Fflag{You_found_XSS_EZ}: confirm(' + msg + ')';
	};
	...
	wp.onPrompt = function(msg) {
		...
		xss.value = 1;
		xss.msg += 'flag{You_found_XSS_EZ}: prompt(' + msg + ')';
	};
